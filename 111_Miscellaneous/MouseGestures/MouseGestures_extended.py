...
overview = """\<html><body>
<h2<center>>wx.lib.gestures</center></h2>
...
# TODO:
# 001. Add a dialog to record gestures  (Have it showcase the manual mode)
# 002. Allow users to remove gestures
...
class TestPanel(wx.Panel):
    ...
    def LogSomethingClever(self, somethingclever):
        self.log.WriteText('%s'%somethingclever)
