...
def GetDemos():
    ...
    # The tree item text.
    TreeItemText = "ScrolledMessageDialog"

    # The tree item's demos.
    TreeItemDemos = (
        'ScrolledMessageDialog_extended.py',
        'ScrolledMessageDialog_minimal.py',
        )
...
def GetOverview():
    ...
    wxHtmlOverviewStr = '''\
    <html><body>
    <center><h2>ScrolledMessageDialog</h2></center>
    <p>ScrolledMessageDialog demos.
    </body></html>
    '''
