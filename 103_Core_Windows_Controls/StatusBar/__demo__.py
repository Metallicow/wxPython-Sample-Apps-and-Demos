...
def GetDemos():
    ...
    # The tree item text.
    TreeItemText = "StatusBar"

    # The tree item's demos.
    TreeItemDemos = (
        'StatusBar_extended.py',
        'StatusBar_minimal.py',
        )
...
def GetOverview():
    ...
    wxHtmlOverviewStr = '''\
    <html><body>
    <center><h2>wx.StatusBar</h2></center>
    <a href="http://wxpython.org/Phoenix/docs/html/StatusBar.html">
             http://wxpython.org/Phoenix/docs/html/StatusBar.html</a>
    <p>StatusBar demos.
    </body></html>
    '''
