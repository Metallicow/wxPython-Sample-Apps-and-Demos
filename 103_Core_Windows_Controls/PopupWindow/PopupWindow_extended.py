...
overview = """<html><body>
<h2><center>PopupWindow</center></h2>
...
class TestTransientPopup(wx.PopupTransientWindow):
    ...
    def ProcessLeftDown(self, evt):
        self.log.WriteText("ProcessLeftDown: %s\n" % evt.GetPosition())
        return wx.PopupTransientWindow.ProcessLeftDown(self, evt)

    def OnDismiss(self):
        self.log.WriteText("OnDismiss\n")
...
class TestPopupWithListbox(wx.PopupWindow):
    ...
    def OnListBox(self, evt):
        ...
        self.log.WriteText("OnListBox: %s\n" % obj)
        self.log.WriteText('Selected: %s\n' % obj.GetString(evt.GetInt()))
        evt.Skip()
